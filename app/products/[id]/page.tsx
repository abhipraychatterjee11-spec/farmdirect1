...
type Product = { id:string; name:string; category:string; description:string|null; price_inr:number; unit:string; status:string; available_quantity:number; seller_name:string; image_url:string|null; image_source:string|null };
