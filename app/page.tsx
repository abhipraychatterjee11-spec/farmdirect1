...
export default function Home() {
  ...
  const slogans = [["/images/farmer-pride/farmer-wheat.jpg", "Indian farmer among wheat", "Jai Jawan, Jai Kisan"], ["/images/farmer-pride/field-tomorrow.jpg", "Farmland at golden hour", "Kisan hai toh kal hai"], ["/images/farmer-pride/tractor-harvest.jpg", "Tractor working in a crop field", "Annadata Sukhi Bhava"], ["/images/farmer-pride/hands-sprout.jpg", "Hands holding a young green sprout", "Kisan ka samman, desh ka abhimaan"]];
  ...
  return <main className="page-shell">
    ...
    <section className="border-y border-green-950/10 bg-[#edf4e4]"><div className="mx-auto max-w-7xl px-5 pt-16"><p className="slogan-divider">✦ ✦ ✦</p><h2 className="mt-4 text-3xl font-bold md:text-4xl">Proud of our farmers. Proud of our nation.</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">A respectful celebration of the people who grow our food and sustain our communities.</p><div className="mt-9 grid divide-y divide-green-950/10 overflow-hidden rounded-2xl border border-green-950/10 bg-[#faf9f4] shadow-sm sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">{slogans.map(([src, alt, title]) => <article key={title} className="slogan-column"><Image src={src} alt={alt} width={800} height={600} className="slogan-illustration" /><h3 className="mt-7 text-lg font-extrabold leading-6 text-ink">{title}</h3></article>)}</div></div><Image src="/images/farmer-pride/landscape.jpg" alt="Panoramic green farm landscape" width={1600} height={500} className="pride-landscape" /></section>
