...
const isProtected = (pathname: string) => pathname.startsWith("/account/") || pathname.startsWith("/farmer") || pathname === "/bulk" || pathname.startsWith("/bulk/") || pathname.startsWith("/admin") || consumerPaths.some((path) => pathname === path || pathname.startsWith(`${path}/`));
